...
//        }
        ...
        String lat = "-9.553634";
        String lng = "-35.776853";

        DoConfiguration dconf = new DoConfiguration();
        Twitter twitter = dconf.getInstance();
        try {
            //Twitter twitter = new TwitterFactory().getInstance();
            GeoQuery query = new GeoQuery(new GeoLocation(Double.parseDouble(lat), Double.parseDouble(lng)));
